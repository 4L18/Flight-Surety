...
async function setup() {
  ...
  web3 = await new Web3(new Web3.providers.WebsocketProvider(config.url.replace('http', 'ws')));
  flightSuretyApp = await new web3.eth.Contract(FlightSuretyApp.abi, config.appAddress);
